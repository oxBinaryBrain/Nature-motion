    ...
    return (
        <>
            ...
            <motion.div
                ...
                className="fixed z-[100] left-1/2 bottom-4 -translate-x-1/2 touch-none"
            >
                <motion.div
    ...
    return (
        <div className="container mx-auto px-4 py-0 max-w-7xl">
            <div className="mb-6 text-left">
                <motion.h2
                    className="text-3xl md:text-5xl lg:text-6xl font-display font-bold mb-3 tracking-tight text-ink-900"
                ...
                <motion.p
                    className="mt-1 text-base md:text-lg text-ink-600 max-w-2xl"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
            ...
            <AnimatePresence mode="wait">
                {selectedItem ? (
                    ...
                    <motion.div
                        className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 grid-flow-dense gap-4 auto-rows-[95px]"
                        initial="hidden"
                        whileInView="visible"
                        viewport={{ once: true }}
                        exit="hidden"
                    ...
                    >
                        {items.map((item, index) => (
                            <motion.div
                                ...
                                className={`relative overflow-hidden rounded-[2rem] border border-black/8 bg-white cursor-move shadow-sm hover:shadow-md transition-shadow duration-300 ${item.span}`}
                            ...
                            >
                                ...
                                >
                                    <div className="absolute inset-0 flex flex-col justify-end p-6">
                                        ...
                                        <h3 className="relative text-white text-xl font-display font-bold line-clamp-1">
                                            {item.title}
                                        </h3>
